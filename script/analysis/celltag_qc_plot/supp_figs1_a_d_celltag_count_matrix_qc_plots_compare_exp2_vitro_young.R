...
dir.create(wdir, recursive = TRUE, showWarnings = FALSE)
    ...
    #   1.000   2.000   3.000   4.412   6.000  48.000
    # > summary(df_n_tags_f[df_n_tags_f$dataset == 'Young2', 2])
    #    Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
    #   1.000   1.000   2.000   3.552   5.000  32.000
    # > summary(df_n_tags_f[df_n_tags_f$dataset == 'Young3', 2])
    #    Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
    #   1.000   2.000   3.000   4.388   6.000  31.000
    ...
    bp2_3
    ggsave(sprintf("figs1_a_left_panel_%s_CellTag_cells_per_tag_boxplot_3datasets.pdf", dsname),
    ...
    # > summary(df_tagfreq[df_tagfreq$dataset == 'Young1', 2])
    #    Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
    #   1.000   1.000   2.000   5.335   6.000 123.000
    # > summary(df_tagfreq[df_tagfreq$dataset == 'Young2', 2])
    #    Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
    #   1.000   1.000   3.000   8.261   9.000 191.000
    # > summary(df_tagfreq[df_tagfreq$dataset == 'Young3', 2])
    #    Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
    #   1.000   1.000   3.000   8.187  10.000 190.000
    ...
    ggsave(sprintf("figs1_d_left_panel__%s_CellTag_distribution_histogrm_hp2.pdf", dsname),
